<template>
    <div class="modal" :class="openmodal">
        ...
        <div class="modal-card">
            ...
            <p class="modal-card-title">Update of {{ list.name }}</p>
            ...
            <section class="modal-card-body">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input is-primary" :class="{'is-danger':errors.phone}" type="number" placeholder="Phone" v-model="list.phone">
                    </div>
